...
**Цель репозитория:** ознакомить вас со своими навыками и знаниями, а также показать как я пользуюсь ими на практике.

**Про обучение:** в ходе обучения я прошел следующие этапы анализа данных: получение и обзор данных, предобработка данных, исследовательский и статистический анализ данных, выдвижение гипотех и их приоритизация, проведение A/B-тестирования, автоматизация процессов, основы машинного обучения, работа с базами данных, визуализация данных.
